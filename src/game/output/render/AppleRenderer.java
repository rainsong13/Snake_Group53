...
public class AppleRenderer {
    ...
    static {
        try {
            appleImages.put(Color.RED, new ImageIcon("src/game/output/image/apple/redapple.png"));
            appleImages.put(Color.YELLOW, new ImageIcon("src/game/output/image/apple/yellowapple.png"));
            appleImages.put(Color.GREEN, new ImageIcon("src/game/output/image/apple/greenapple.png"));
        } catch (Exception e) {
