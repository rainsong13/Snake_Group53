...
public class SnakeRenderer {
    ...
    private void loadImages() {
        // 加载蛇头和身体的图像
        headImage = new ImageIcon(getClass().getResource("/game/render/image/snake/head.png")).getImage();
        bodyImage = new ImageIcon(getClass().getResource("/game/render/image/snake/body.png")).getImage();
    }
